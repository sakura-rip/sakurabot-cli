...
// ListCommand base command for "product list"
...
// runListCommand execute "product list" command
func runListCommand(cmd *cobra.Command, args []string) {
	...
	database.Preload(clause.Associations).Find(&products)
	database.PrintProducts(products)
}
